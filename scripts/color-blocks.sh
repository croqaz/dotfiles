...
# From: https://github.com/Airblader/dotfiles-manjaro/blob/master/scripts/colors.sh
...
# note in this first use that switching colors doesn't require
# a reset first - the new color overrides the old one.
